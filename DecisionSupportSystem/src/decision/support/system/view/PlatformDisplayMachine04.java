...
import static decision.support.system.view.PlatformDisplayMachine03.BACK;
...
public class PlatformDisplayMachine04 extends JPanel{
    
    
    private final static int NO_OF_SENSORS = 5;
    private final static int NO_OF_TESTS = 6;
    
    private final PlatformDisplayMachine04Controller controller;
    ...
    private final JLabel machineName = new JLabel("Machine 2");
    ...
    public PlatformDisplayMachine04(PlatformView platformView) {
        ...
        this.controller = new PlatformDisplayMachine04Controller(this);
